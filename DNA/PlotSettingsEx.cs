...
namespace DotNetARX
{
    ...
    public class PlotSettingsEx : PlotSettings, INotifyPropertyChanged
    {
            ...
            set
            {
                if (value != CurrentStyleSheet)
                {
                    if (value != "无")
                        ...
                        validator.SetCurrentStyleSheet(this, "");
        ...
        public bool PlotExtent
        {
            get
            {
                if (UseStandardScale && StdScaleType == StdScaleType.ScaleToFit)
                    return true;
                else
                    return false;
            }
            set
            {
                if (value != PlotExtent)
                {
                    if (value)
                    {
                        ...
                        validator.SetUseStandardScale(this, false);
        ...
        public bool PlotReverse
        {
            get
            {
                if (PlotRotation == PlotRotation.Degrees180 || PlotRotation == PlotRotation.Degrees270)
                    return true;
                else
                    return false;
            }
            set
            {
                if (value != PlotReverse)
                {
                    ...
                    if (value == true)
                        ...
                        numRotation -= 2;
                    validator.SetPlotRotation(this, (PlotRotation)numRotation);
