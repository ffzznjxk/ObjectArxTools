...
namespace DotNetARX
{
    ...
    public static class UCSTools
    {
        ...
        /// <returns>角度</returns>
        public static double GetUcsAngle(this Database db)
        {
            Matrix3d ucs = db.GetEditor().CurrentUserCoordinateSystem;
            CoordinateSystem3d cs = ucs.CoordinateSystem3d;
            return cs.Xaxis.AngleOnPlane(new Plane(Point3d.Origin, Vector3d.ZAxis));
        }
    }
}
