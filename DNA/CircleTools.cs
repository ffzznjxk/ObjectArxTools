...
/* Unmerged change from project 'DNA2010'
Before:
using System;
...
After:
using Autodesk.AutoCAD.DatabaseServices;
using Autodesk.Collections.Geometry;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
...
/* Unmerged change from project 'DNA2012'
Before:
using System;
using System.Collections.Generic;
using System.Linq;
...
/* Unmerged change from project 'DNA2013'
Before:
using System;
using System.Collections.Generic;
using System.Linq;
...
namespace DotNetARX
{
    ...
    public static class CircleTools
    {
        ...
        {
            circle.Center = GeoTools.MidPoint(startPoint, endPoint);
