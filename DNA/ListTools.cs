...
namespace DotNetARX
{
    ...
    public class TypedValueList : List<TypedValue>
    {
        ...
        {
            Add(new TypedValue(typecode, value));
        }
        ...
        {
            Add(new TypedValue((int)typecode, value));
        }
        ...
        {
            Add(new TypedValue((int)typecode));
        }
        ...
        {
            Add(new TypedValue(0, RXObject.GetClass(entityType).DxfName));
        }
